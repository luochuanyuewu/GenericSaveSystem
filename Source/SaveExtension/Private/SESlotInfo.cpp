...
UTexture2D* USESlotInfo::GetThumbnail() const
{
	...
	const_cast<USESlotInfo*>(this)->CachedThumbnail = Texture;
	return Texture;
}

bool USESlotInfo::CaptureThumbnail(const int32 Width /*= 640*/, const int32 Height /*= 360*/)
{
	...
	{
		_SetThumbnailPath(FSEFileAdapter::GetThumbnailPath(FileName.ToString()));
...
void USESlotInfo::_SetThumbnailPath(const FString& Path)
{
