...
class SAVEEXTENSION_API USESavePreset : public UObject
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	TSubclassOf<USESlotInfo> SlotInfoClass;

	/**
	* Specify the SaveData object to be used with this preset
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Gameplay)
	TSubclassOf<USESlotData> SlotDataClass;
...
inline int32 USESavePreset::GetMaxIds() const
{
	return MaxSlots <= 0 ? 16384 : MaxSlots;
}

inline bool USESavePreset::IsValidId(int32 Id) const
{
